...
class Student(models.Model):
    ...
    foto = models.FileField(upload_to=_upload_path,  blank=True, null=True,validators=[FileExtensionValidator(['jpg']), file_size])
    ijazah = models.FileField(upload_to=_upload_path, blank=True, null=True, validators=[FileExtensionValidator(['pdf']), file_size])
    SKHUN = models.FileField(upload_to=_upload_path,  blank=True, null=True, validators=[FileExtensionValidator(['pdf']), file_size])
